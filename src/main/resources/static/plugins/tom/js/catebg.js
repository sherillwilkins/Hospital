var w = d.width = document.getElementById('content').clientWidth,
    h = d.height = document.querySelector('.site-header').clientHeight,
    ctx = d.getContext('2d'),
...
function init() {
    w = d.width = document.getElementById('content').clientWidth;
    h = d.height = document.querySelector('.site-header').clientHeight;
    total = (w / 8) | 0;
    size = w / total;
    occupation = w / total;
